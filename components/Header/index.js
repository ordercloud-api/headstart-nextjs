                    ...
                    <div className={styles['login-header']}>
                      <span className={styles['login-icon']}>
                        <svg
                          ...
                          height="20"
                        >
                          <path d="M10.125 8.625a1.875 1.875 0 1 0 0-3.75 1.875 1.875 0 0 0 0 3.75zm2.5 2.813c1.726 0 3.125 1.482 3.125 3.31V17h-1.875v-2.253c0-.816-.585-1.435-1.25-1.435h-5c-.665 0-1.25.619-1.25 1.435V17H4.5v-2.253c0-1.828 1.4-3.31 3.125-3.31zM10.125 3a3.75 3.75 0 1 1 0 7.5 3.75 3.75 0 0 1 0-7.5z" />
                        </svg>
                      </span>
